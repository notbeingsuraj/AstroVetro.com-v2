const FOOTER_LINKS = {
  ...
  Guidance: ["Tarot Readings", "Book a Session", "Gift a Reading", "FAQ"],
};
        ...
        <div className="grid gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="mt-4 max-w-xs text-pretty text-sm leading-relaxed text-ink-soft">
              Crystals, meaningful objects and intuitive guidance — inspired
              by the connection between what we carry, what we feel and the
              world around us.
            </p>
          </div>
