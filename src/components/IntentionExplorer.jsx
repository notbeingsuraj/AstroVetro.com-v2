              ...
              return (
                ...
                >
                  ...
                  <motion.span
                    ...
                    className="block font-display text-5xl lg:text-6xl leading-tight transition-all duration-300"
                  >
                  ...
                  <AnimatePresence>
                    {(isActive || isHovered) && (
                      <motion.p
                        ...
                        exit={{ opacity: 0, y: -10 }}
                        transition={{ duration: 0.3 }}
                        className="mt-5 text-base leading-relaxed text-ink/70 max-w-[240px]"
                      >
                  ...
                  <motion.div
                    ...
                    className="mt-5 h-1 w-full origin-left"
